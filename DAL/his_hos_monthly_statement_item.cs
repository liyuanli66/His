...
namespace HIS.DAL
{
	...
	public partial class his_hos_monthly_statement_item
	{
		...
		public bool Add(HIS.Model.his_hos_monthly_statement_item model)
		{
			...
			if (model.MONTHLY_CODE != null)
			{
				strSql1.Append("MONTHLY_CODE,");
				strSql2.Append("'"+model.MONTHLY_CODE+"',");
			}
		...
		public bool Update(HIS.Model.his_hos_monthly_statement_item model)
		{
			...
			strSql.Remove(n, 1);
			strSql.Append(" where ID='"+ model.ID+"' and MONTHLY_CODE='"+ model.MONTHLY_CODE+"' ");
		...
		public HIS.Model.his_hos_monthly_statement_item GetModel(string ID,string MONTHLY_CODE)
		{
			...
			strSql.Append(" where ID='"+ID+"' and MONTHLY_CODE='"+MONTHLY_CODE+"' " );
			HIS.Model.his_hos_monthly_statement_item model=new HIS.Model.his_hos_monthly_statement_item();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_hos_monthly_statement_item DataRowToModel(DataRow row)
		{
			HIS.Model.his_hos_monthly_statement_item model=new HIS.Model.his_hos_monthly_statement_item();
			if (row != null)
			{
