...
namespace HIS.DAL
{
	...
	public partial class his_cl_daily_statement
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HIS.Model.his_cl_daily_statement model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HIS.Model.his_cl_daily_statement model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_cl_daily_statement GetModel(string ID)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append(" where ID='"+ID+"' " );
			HIS.Model.his_cl_daily_statement model=new HIS.Model.his_cl_daily_statement();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_cl_daily_statement DataRowToModel(DataRow row)
		{
			HIS.Model.his_cl_daily_statement model=new HIS.Model.his_cl_daily_statement();
			if (row != null)
			{
