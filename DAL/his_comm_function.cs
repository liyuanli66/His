...
namespace HIS.DAL
{
	...
	public partial class his_comm_function
	{
		...
		public bool Add(HIS.Model.his_comm_function model)
		{
			...
			if (model.FUNCTION_CODE != null)
			{
				strSql1.Append("FUNCTION_CODE,");
				strSql2.Append("'"+model.FUNCTION_CODE+"',");
			}
			if (model.FUNCTION_NAME != null)
			{
				strSql1.Append("FUNCTION_NAME,");
				strSql2.Append("'"+model.FUNCTION_NAME+"',");
			}
		...
		public bool Update(HIS.Model.his_comm_function model)
		{
			...
			if (model.FUNCTION_CODE != null)
			{
				strSql.Append("FUNCTION_CODE='"+model.FUNCTION_CODE+"',");
			}
			else
			{
				strSql.Append("FUNCTION_CODE= null ,");
			}
			if (model.FUNCTION_NAME != null)
			{
				strSql.Append("FUNCTION_NAME='"+model.FUNCTION_NAME+"',");
			}
			else
			{
				strSql.Append("FUNCTION_NAME= null ,");
			}
			if (model.IS_USE != null)
			{
		...
		public HIS.Model.his_comm_function GetModel(string ID)
		{
			...
			strSql.Append(" where ID='"+ID+"' " );
			HIS.Model.his_comm_function model=new HIS.Model.his_comm_function();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_comm_function DataRowToModel(DataRow row)
		{
			HIS.Model.his_comm_function model=new HIS.Model.his_comm_function();
			if (row != null)
			{
