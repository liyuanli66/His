...
namespace HIS.DAL
{
	...
	public partial class his_bil_cl_receipt
	{
		...
		public bool Add(HIS.Model.his_bil_cl_receipt model)
		{
			...
			if (model.REFUND_RECP_CODE != null)
			{
				strSql1.Append("REFUND_RECP_CODE,");
				strSql2.Append("'"+model.REFUND_RECP_CODE+"',");
			}
			if (model.REFUND_DATE != null)
			{
				strSql1.Append("REFUND_DATE,");
				strSql2.Append("'"+model.REFUND_DATE+"',");
			}
			if (model.REFUND_OPT != null)
			{
				strSql1.Append("REFUND_OPT,");
				strSql2.Append("'"+model.REFUND_OPT+"',");
			}
		...
		public bool Update(HIS.Model.his_bil_cl_receipt model)
		{
			...
			if (model.REFUND_RECP_CODE != null)
			{
				strSql.Append("REFUND_RECP_CODE='"+model.REFUND_RECP_CODE+"',");
			}
			else
			{
				strSql.Append("REFUND_RECP_CODE= null ,");
			}
			if (model.REFUND_DATE != null)
			{
				strSql.Append("REFUND_DATE='"+model.REFUND_DATE+"',");
			}
			else
			{
				strSql.Append("REFUND_DATE= null ,");
			}
			if (model.REFUND_OPT != null)
			{
				strSql.Append("REFUND_OPT='"+model.REFUND_OPT+"',");
			}
			else
			{
				strSql.Append("REFUND_OPT= null ,");
			}
			if (model.REDUCE_AMT != null)
			{
			...
			strSql.Remove(n, 1);
			strSql.Append(" where CL_RECEIPT_CODE='"+ model.CL_RECEIPT_CODE+"' and CL_CODE='"+ model.CL_CODE+"' ");
		...
		public HIS.Model.his_bil_cl_receipt GetModel(string CL_RECEIPT_CODE,string CL_CODE)
		{
			...
			strSql.Append(" where CL_RECEIPT_CODE='"+CL_RECEIPT_CODE+"' and CL_CODE='"+CL_CODE+"' " );
			HIS.Model.his_bil_cl_receipt model=new HIS.Model.his_bil_cl_receipt();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_bil_cl_receipt DataRowToModel(DataRow row)
		{
			HIS.Model.his_bil_cl_receipt model=new HIS.Model.his_bil_cl_receipt();
			if (row != null)
			{
