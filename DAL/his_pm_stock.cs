...
namespace HIS.DAL
{
	...
	public partial class his_pm_stock
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HIS.Model.his_pm_stock model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HIS.Model.his_pm_stock model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_pm_stock GetModel(string ID)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append(" where ID='"+ID+"' " );
			HIS.Model.his_pm_stock model=new HIS.Model.his_pm_stock();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_pm_stock DataRowToModel(DataRow row)
		{
			HIS.Model.his_pm_stock model=new HIS.Model.his_pm_stock();
			if (row != null)
			{
