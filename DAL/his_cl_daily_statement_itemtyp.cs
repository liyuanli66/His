...
namespace HIS.DAL
{
	...
	public partial class his_cl_daily_statement_itemtyp
	{
		...
		public HIS.Model.his_cl_daily_statement_itemtyp GetModel(string ID,string DAILY_CODE)
		{
			...
			strSql.Append(" where ID='"+ID+"' and DAILY_CODE='"+DAILY_CODE+"' " );
			HIS.Model.his_cl_daily_statement_itemtyp model=new HIS.Model.his_cl_daily_statement_itemtyp();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_cl_daily_statement_itemtyp DataRowToModel(DataRow row)
		{
			HIS.Model.his_cl_daily_statement_itemtyp model=new HIS.Model.his_cl_daily_statement_itemtyp();
			if (row != null)
			{
