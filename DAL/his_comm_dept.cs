...
namespace HIS.DAL
{
	...
	public partial class his_comm_dept
	{
		...
		public bool Add(HIS.Model.his_comm_dept model)
		{
			...
			if (model.DEPT_TYPE != null)
			{
				strSql1.Append("DEPT_TYPE,");
				strSql2.Append("'"+model.DEPT_TYPE+"',");
			}
		...
		public bool Update(HIS.Model.his_comm_dept model)
		{
			...
			if (model.DEPT_TYPE != null)
			{
				strSql.Append("DEPT_TYPE='"+model.DEPT_TYPE+"',");
			}
			else
			{
				strSql.Append("DEPT_TYPE= null ,");
			}
			if (model.HOSPITAL_CODE != null)
			{
		...
		public HIS.Model.his_comm_dept GetModel(string ID)
		{
			...
			strSql.Append(" where ID='"+ID+"' " );
			HIS.Model.his_comm_dept model=new HIS.Model.his_comm_dept();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_comm_dept DataRowToModel(DataRow row)
		{
			HIS.Model.his_comm_dept model=new HIS.Model.his_comm_dept();
			if (row != null)
			{
