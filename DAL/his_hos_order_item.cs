...
namespace HIS.DAL
{
	...
	public partial class his_hos_order_item
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HIS.Model.his_hos_order_item model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HIS.Model.his_hos_order_item model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_hos_order_item GetModel(string ID,string HOS_PRES_CODE,string HIS_HOS_CODE)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append(" where ID='"+ID+"' and HOS_PRES_CODE='"+HOS_PRES_CODE+"' and HIS_HOS_CODE='"+HIS_HOS_CODE+"' " );
			HIS.Model.his_hos_order_item model=new HIS.Model.his_hos_order_item();
		...
		/// 得到一个对象实体
		/// </summary>
		public HIS.Model.his_hos_order_item DataRowToModel(DataRow row)
		{
			HIS.Model.his_hos_order_item model=new HIS.Model.his_hos_order_item();
			if (row != null)
			{
