...
namespace HisClient.BLL {
		...
		public partial class his_cl_order_item
	{
		...
		private readonly HisClient.DAL.his_cl_order_item dal=new HisClient.DAL.his_cl_order_item();
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(HisClient.Model.his_cl_order_item model)
		{
						dal.Add(model);
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_cl_order_item> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_cl_order_item> DataTableToList(DataTable dt)
		{
			List<HisClient.Model.his_cl_order_item> modelList = new List<HisClient.Model.his_cl_order_item>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HisClient.Model.his_cl_order_item model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new HisClient.Model.his_cl_order_item();					
