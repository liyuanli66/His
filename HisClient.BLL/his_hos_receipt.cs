...
namespace HisClient.BLL {
		...
		public partial class his_hos_receipt
	{
		...
		private readonly HisClient.DAL.his_hos_receipt dal=new HisClient.DAL.his_hos_receipt();
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(HisClient.Model.his_hos_receipt model)
		{
						dal.Add(model);
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_hos_receipt> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_hos_receipt> DataTableToList(DataTable dt)
		{
			List<HisClient.Model.his_hos_receipt> modelList = new List<HisClient.Model.his_hos_receipt>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HisClient.Model.his_hos_receipt model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new HisClient.Model.his_hos_receipt();					
