...
namespace HisClient.BLL {
	 	//his_ds_changepriceinfo
		public partial class his_ds_changepriceinfo
	{
   		     
		private readonly HisClient.DAL.his_ds_changepriceinfo dal=new HisClient.DAL.his_ds_changepriceinfo();
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(HisClient.Model.his_ds_changepriceinfo model)
		{
						dal.Add(model);
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_ds_changepriceinfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_ds_changepriceinfo> DataTableToList(DataTable dt)
		{
			List<HisClient.Model.his_ds_changepriceinfo> modelList = new List<HisClient.Model.his_ds_changepriceinfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HisClient.Model.his_ds_changepriceinfo model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new HisClient.Model.his_ds_changepriceinfo();					
																												...
																												if(dt.Rows[n]["MED_MADETIME"].ToString()!="")
				{
					model.MED_MADETIME=DateTime.Parse(dt.Rows[n]["MED_MADETIME"].ToString());
																												...
																												if(dt.Rows[n]["NEW_PRICE"].ToString()!="")
				{
