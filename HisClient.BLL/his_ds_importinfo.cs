...
namespace HisClient.BLL {
		...
		public partial class his_ds_importinfo
	{
		...
		private readonly HisClient.DAL.his_ds_importinfo dal=new HisClient.DAL.his_ds_importinfo();
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(HisClient.Model.his_ds_importinfo model)
		{
						dal.Add(model);
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_ds_importinfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_ds_importinfo> DataTableToList(DataTable dt)
		{
			List<HisClient.Model.his_ds_importinfo> modelList = new List<HisClient.Model.his_ds_importinfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HisClient.Model.his_ds_importinfo model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new HisClient.Model.his_ds_importinfo();					
				...
				{
					model.PAKAGE_AMOUNT=int.Parse(dt.Rows[n]["PAKAGE_AMOUNT"].ToString());
				}
