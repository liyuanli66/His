...
namespace HisClient.BLL {
		...
		public partial class his_hos_receipt_detail
	{
		...
		private readonly HisClient.DAL.his_hos_receipt_detail dal=new HisClient.DAL.his_hos_receipt_detail();
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(HisClient.Model.his_hos_receipt_detail model)
		{
						dal.Add(model);
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_hos_receipt_detail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_hos_receipt_detail> DataTableToList(DataTable dt)
		{
			List<HisClient.Model.his_hos_receipt_detail> modelList = new List<HisClient.Model.his_hos_receipt_detail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HisClient.Model.his_hos_receipt_detail model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new HisClient.Model.his_hos_receipt_detail();					
