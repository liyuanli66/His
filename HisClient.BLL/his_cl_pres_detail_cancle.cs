...
namespace HisClient.BLL {
		...
		public partial class his_cl_pres_detail_cancle
	{
		...
		private readonly HisClient.DAL.his_cl_pres_detail_cancle dal=new HisClient.DAL.his_cl_pres_detail_cancle();
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(HisClient.Model.his_cl_pres_detail_cancle model)
		{
						dal.Add(model);
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_cl_pres_detail_cancle> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HisClient.Model.his_cl_pres_detail_cancle> DataTableToList(DataTable dt)
		{
			List<HisClient.Model.his_cl_pres_detail_cancle> modelList = new List<HisClient.Model.his_cl_pres_detail_cancle>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HisClient.Model.his_cl_pres_detail_cancle model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new HisClient.Model.his_cl_pres_detail_cancle();					
