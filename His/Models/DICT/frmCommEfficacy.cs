    ...
    public partial class frmCommEfficacy : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void Query(string strw)
        {
            try
            {
                ...
                comfun.dgvstyle(gridView1, 1, "EFFICACY_CODE", "编码", 15, true, true, DevExpress.Utils.HorzAlignment.Center, DevExpress.XtraGrid.Columns.FixedStyle.Left, true);
                comfun.dgvstyle(gridView1, 2, "EFFICACY_NAME", "名称", 15, true, true, DevExpress.Utils.HorzAlignment.Center, DevExpress.XtraGrid.Columns.FixedStyle.Left, true);
