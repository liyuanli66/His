...
{
	/// <summary>
	/// 数据访问类:his_hos_receipt_detail
	/// </summary>
	public partial class his_hos_receipt_detail
	{
		public his_hos_receipt_detail()
		{}
		#region  BasicMethod
		...
		public bool Exists(string ID,string HOS_RECEIPT_CODE,string HIS_HOS_CODE)
		{
			...
			strSql.Append("select count(1) from his_hos_receipt_detail");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HisClient.Model.his_hos_receipt_detail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update his_hos_receipt_detail set ");
		...
		public bool Delete(string ID,string HOS_RECEIPT_CODE,string HIS_HOS_CODE)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from his_hos_receipt_detail ");
			strSql.Append(" where ID=@ID and HOS_RECEIPT_CODE=@HOS_RECEIPT_CODE and HIS_HOS_CODE=@HIS_HOS_CODE ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18),
					new MySqlParameter("@HOS_RECEIPT_CODE", MySqlDbType.VarChar,18),
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_hos_receipt_detail GetModel(string ID,string HOS_RECEIPT_CODE,string HIS_HOS_CODE)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,HOS_RECEIPT_CODE,HIS_HOS_CODE,FEEITEM_CODE,FEEITEM_NAME,PRICE,COUNT,UNIT,AMT,OPT_USER,OPT_DATE,OPT_TERM,OPT_ORGA from his_hos_receipt_detail ");
			strSql.Append(" where ID=@ID and HOS_RECEIPT_CODE=@HOS_RECEIPT_CODE and HIS_HOS_CODE=@HIS_HOS_CODE ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18),
					new MySqlParameter("@HOS_RECEIPT_CODE", MySqlDbType.VarChar,18),
			...
			HisClient.Model.his_hos_receipt_detail model=new HisClient.Model.his_hos_receipt_detail();
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_hos_receipt_detail DataRowToModel(DataRow row)
		{
			HisClient.Model.his_hos_receipt_detail model=new HisClient.Model.his_hos_receipt_detail();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM his_hos_receipt_detail ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from his_hos_receipt_detail T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "his_hos_receipt_detail";
