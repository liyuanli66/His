...
namespace HisClient.DAL
{
	...
	public partial class his_ds_changepriceinfo
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HisClient.Model.his_ds_changepriceinfo model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@NEW_PRICE", MySqlDbType.Decimal,12),
			...
			parameters[13].Value = model.NEW_PRICE;
			parameters[14].Value = model.CHANGE_CODE;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HisClient.Model.his_ds_changepriceinfo model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[12].Value = model.NEW_PRICE;
			parameters[13].Value = model.CHANGE_CODE;
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_ds_changepriceinfo GetModel(string ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,MEDINFO_CODE,MED_NAME,MED_SPC,VALIDITY_DATE,MED_PRICE,PURCHASE_PRICE,WHOLESALE_PRICE,CREATE_DATE,CREATE_BY,PAKAGE_UNIT,MED_MADETIME,BATCHNO,NEW_PRICE,CHANGE_CODE from his_ds_changepriceinfo ");
			strSql.Append(" where ID=@ID ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18)			};
			parameters[0].Value = ID;

			HisClient.Model.his_ds_changepriceinfo model=new HisClient.Model.his_ds_changepriceinfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_ds_changepriceinfo DataRowToModel(DataRow row)
		{
			HisClient.Model.his_ds_changepriceinfo model=new HisClient.Model.his_ds_changepriceinfo();
			if (row != null)
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "his_ds_changepriceinfo";
