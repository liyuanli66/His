...
namespace HisClient.DAL
{
	...
	public partial class his_comm_hospital
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HisClient.Model.his_comm_hospital model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@HOSPITAL_NAME", MySqlDbType.VarChar,128),
					new MySqlParameter("@HOSPITAL_LEVEL", MySqlDbType.VarChar,128),
			...
			parameters[2].Value = model.HOSPITAL_NAME;
			parameters[3].Value = model.HOSPITAL_LEVEL;
		...
		public bool Update(HisClient.Model.his_comm_hospital model)
		{
			...
			parameters[2].Value = model.HOSPITAL_LEVEL;
		...
		public HisClient.Model.his_comm_hospital GetModel(string ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,HOSPITAL_CODE,HOSPITAL_NAME,HOSPITAL_LEVEL,HELP_CODE,CREATE_DATE,CREATE_BY from his_comm_hospital ");
			strSql.Append(" where ID=@ID ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18)			};
			parameters[0].Value = ID;

			HisClient.Model.his_comm_hospital model=new HisClient.Model.his_comm_hospital();
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_comm_hospital DataRowToModel(DataRow row)
		{
			HisClient.Model.his_comm_hospital model=new HisClient.Model.his_comm_hospital();
			if (row != null)
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "his_comm_hospital";
