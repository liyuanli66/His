...
namespace HisClient.DAL
{
	...
	public partial class his_hos_receipt_cancle
	{
		...
		public bool Exists(string HOS_RECEIPT_CODE,string HIS_HOS_CODE)
		{
			...
			strSql.Append("select count(1) from his_hos_receipt_cancle");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HisClient.Model.his_hos_receipt_cancle model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into his_hos_receipt_cancle(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update his_hos_receipt_cancle set ");
		...
		public bool Delete(string HOS_RECEIPT_CODE,string HIS_HOS_CODE)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from his_hos_receipt_cancle ");
			strSql.Append(" where HOS_RECEIPT_CODE=@HOS_RECEIPT_CODE and HIS_HOS_CODE=@HIS_HOS_CODE ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@HOS_RECEIPT_CODE", MySqlDbType.VarChar,18),
					new MySqlParameter("@HIS_HOS_CODE", MySqlDbType.VarChar,18)			};
		...
		public HisClient.Model.his_hos_receipt_cancle GetModel(string HOS_RECEIPT_CODE,string HIS_HOS_CODE)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select HOS_RECEIPT_CODE,HIS_HOS_CODE,CASHIER,RECEICPT_CODE,RECIVER_TIME,CASH_AMT,CARD_AMT,INSURANCE_AMT,SUM_AMT,REDUCE_AMT,REDUCE_DATE,REDUCE_OPT,REDUCE_REASON,OPT_USER,OPT_DATE,OPT_TERM,OPT_ORGA from his_hos_receipt_cancle ");
			strSql.Append(" where HOS_RECEIPT_CODE=@HOS_RECEIPT_CODE and HIS_HOS_CODE=@HIS_HOS_CODE ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@HOS_RECEIPT_CODE", MySqlDbType.VarChar,18),
					new MySqlParameter("@HIS_HOS_CODE", MySqlDbType.VarChar,18)			};
			...
			HisClient.Model.his_hos_receipt_cancle model=new HisClient.Model.his_hos_receipt_cancle();
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_hos_receipt_cancle DataRowToModel(DataRow row)
		{
			HisClient.Model.his_hos_receipt_cancle model=new HisClient.Model.his_hos_receipt_cancle();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM his_hos_receipt_cancle ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from his_hos_receipt_cancle T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "his_hos_receipt_cancle";
			parameters[1].Value = "HIS_HOS_CODE";
