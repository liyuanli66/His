...
namespace HisClient.DAL
{
	...
	public partial class his_pm_import
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HisClient.Model.his_pm_import model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@RECEIVE_DEPT_CODE", MySqlDbType.VarChar,18),
					new MySqlParameter("@PAKAGE_OUT_CODE", MySqlDbType.VarChar,18),
			...
			parameters[1].Value = model.SEND_DEPT_CODE;
			parameters[2].Value = model.RECEIVE_DEPT_CODE;
			parameters[3].Value = model.PAKAGE_OUT_CODE;
			parameters[4].Value = model.CREATE_BY;
			parameters[5].Value = model.CREATE_DATE;
			parameters[6].Value = model.IMPORT_CODE;
		...
		public bool Update(HisClient.Model.his_pm_import model)
		{
			...
			strSql.Append("PAKAGE_OUT_CODE=@PAKAGE_OUT_CODE,");
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@IMPORT_CODE", MySqlDbType.VarChar,18),
					new MySqlParameter("@ID", MySqlDbType.VarChar,18)};
			parameters[0].Value = model.SEND_DEPT_CODE;
			parameters[1].Value = model.RECEIVE_DEPT_CODE;
			parameters[2].Value = model.PAKAGE_OUT_CODE;
			parameters[3].Value = model.CREATE_BY;
			parameters[4].Value = model.CREATE_DATE;
			parameters[5].Value = model.IMPORT_CODE;
		...
		public HisClient.Model.his_pm_import GetModel(string ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,SEND_DEPT_CODE,RECEIVE_DEPT_CODE,PAKAGE_OUT_CODE,CREATE_BY,CREATE_DATE,IMPORT_CODE from his_pm_import ");
			strSql.Append(" where ID=@ID ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18)			};
			parameters[0].Value = ID;

			HisClient.Model.his_pm_import model=new HisClient.Model.his_pm_import();
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_pm_import DataRowToModel(DataRow row)
		{
			HisClient.Model.his_pm_import model=new HisClient.Model.his_pm_import();
			if (row != null)
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "his_pm_import";
