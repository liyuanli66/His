...
{
	/// <summary>
	/// 数据访问类:his_cl_daily_statement
	/// </summary>
	public partial class his_cl_daily_statement
	{
		public his_cl_daily_statement()
		{}
		#region  BasicMethod
		...
		public bool Exists(string ID)
		{
			...
			strSql.Append("select count(1) from his_cl_daily_statement");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HisClient.Model.his_cl_daily_statement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into his_cl_daily_statement(");
			strSql.Append("ID,OPERATOR,OPERATE_TIME,RECIVER,START_TIME,END_TIME,START_RECEIPT_CODE,END_RECEIPT_CODE,RECEIPT__NUM,RETUEN_RECEIPT_NUM)");
			...
			parameters[2].Value = model.OPERATE_TIME;
			parameters[3].Value = model.RECIVER;
			parameters[4].Value = model.START_TIME;
			parameters[5].Value = model.END_TIME;
			parameters[6].Value = model.START_RECEIPT_CODE;
			parameters[7].Value = model.END_RECEIPT_CODE;
			parameters[8].Value = model.RECEIPT__NUM;
			parameters[9].Value = model.RETUEN_RECEIPT_NUM;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HisClient.Model.his_cl_daily_statement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update his_cl_daily_statement set ");
		...
		public bool Delete(string ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from his_cl_daily_statement ");
			strSql.Append(" where ID=@ID ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18)			};
			parameters[0].Value = ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_cl_daily_statement GetModel(string ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,OPERATOR,OPERATE_TIME,RECIVER,START_TIME,END_TIME,START_RECEIPT_CODE,END_RECEIPT_CODE,RECEIPT__NUM,RETUEN_RECEIPT_NUM from his_cl_daily_statement ");
			strSql.Append(" where ID=@ID ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18)			};
			parameters[0].Value = ID;

			HisClient.Model.his_cl_daily_statement model=new HisClient.Model.his_cl_daily_statement();
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_cl_daily_statement DataRowToModel(DataRow row)
		{
			HisClient.Model.his_cl_daily_statement model=new HisClient.Model.his_cl_daily_statement();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,OPERATOR,OPERATE_TIME,RECIVER,START_TIME,END_TIME,START_RECEIPT_CODE,END_RECEIPT_CODE,RECEIPT__NUM,RETUEN_RECEIPT_NUM ");
			strSql.Append(" FROM his_cl_daily_statement ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from his_cl_daily_statement T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "his_cl_daily_statement";
