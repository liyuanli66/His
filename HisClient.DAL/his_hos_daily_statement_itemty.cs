...
namespace HisClient.DAL
{
	...
	public partial class his_hos_daily_statement_itemty
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(HisClient.Model.his_hos_daily_statement_itemty model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[1].Value = model.ITEM_TYPE;
			parameters[2].Value = model.ITEM_SUM_PAY;
			parameters[3].Value = model.ITEM_CASH_PAY;
			parameters[4].Value = model.ITEM_CARD_PAY;
			parameters[5].Value = model.ITEM_INSURANCE_PAY;
		...
		public HisClient.Model.his_hos_daily_statement_itemty GetModel(string ID,string DAILY_CODE)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ITEM_TYPE,ITEM_SUM_PAY,ITEM_CASH_PAY,ITEM_CARD_PAY,ITEM_INSURANCE_PAY,STATUS,DAILY_CODE from his_hos_daily_statement_itemty ");
			strSql.Append(" where ID=@ID and DAILY_CODE=@DAILY_CODE ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.VarChar,18),
					new MySqlParameter("@DAILY_CODE", MySqlDbType.VarChar,18)			};
			...
			HisClient.Model.his_hos_daily_statement_itemty model=new HisClient.Model.his_hos_daily_statement_itemty();
		...
		/// 得到一个对象实体
		/// </summary>
		public HisClient.Model.his_hos_daily_statement_itemty DataRowToModel(DataRow row)
		{
			HisClient.Model.his_hos_daily_statement_itemty model=new HisClient.Model.his_hos_daily_statement_itemty();
			if (row != null)
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "his_hos_daily_statement_itemty";
			parameters[1].Value = "DAILY_CODE";
